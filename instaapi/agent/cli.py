...
Usage:
    ...
    python -m instaapi.agent.cli --provider gemini "question here"

    # Full access (no permission prompts)
    python -m instaapi.agent.cli --full-access "do something"

    # Compact mode (less verbose output)
    python -m instaapi.agent.cli --compact "question"
"""
